    ...
    <div style={{
      ...
      <div className="menu2-container" style={{
        ...
        <div className="menu2-content-area" style={{
          ...
          <div className="menu2-text-wrapper" style={{ display: 'flex', flexDirection: 'column', maxWidth: '54vw' }}>
